 ...
 */
public class ConciergeArtistAdapter extends
        RecyclerView.Adapter<ConciergeArtistAdapter.ConciergeArtistViewholder>{

    private final LayoutInflater inflator;
    private final ImageLoader mImageLoader;
    private ArrayList<ConciergeArtist> mArtistList;
    private Context context;

    public ConciergeArtistAdapter(Context context, ArrayList<ConciergeArtist> artistList) {
    ...
    @Override
    public ConciergeArtistAdapter.ConciergeArtistViewholder onCreateViewHolder(ViewGroup parent,
                                                                               int viewType) {

        View view = inflator.inflate(R.layout.artist_list_row,parent,false);
        return new ConciergeArtistAdapter.ConciergeArtistViewholder(view);
    }

    @Override
    public void onBindViewHolder(ConciergeArtistAdapter.ConciergeArtistViewholder holder, int position) {
    ...
    public class ConciergeArtistViewholder extends RecyclerView.ViewHolder{
        ...
        public ConciergeArtistViewholder(View itemView) {
            super(itemView);
